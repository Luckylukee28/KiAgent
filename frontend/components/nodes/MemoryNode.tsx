...
import { MemoryData, useNodeGraphStore } from '@/lib/nodeGraphStore'

export default function MemoryNode({ id, data }: NodeProps) {
    ...
    <div className="relative min-w-[155px] bg-[#13131f] border border-[#2d2d50] hover:border-green-500/40 rounded-2xl shadow-xl shadow-black/40 transition-colors">
      ...
      <div className="flex items-center gap-2.5 px-4 pt-4 pb-3">
        ...
        <div className="flex-1 min-w-0">
          <div className="text-[11px] text-slate-500 leading-none mb-0.5">Memory</div>
          <div className="text-[13px] text-slate-200 font-medium">Simple Memory</div>
        </div>
